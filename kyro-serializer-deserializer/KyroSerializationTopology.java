...
public class KyroSerializationTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("object-creator", new ObjectCreator()).shuffleGrouping("word-spout");
		builder.setBolt("object-reader", new ObjectReader()).shuffleGrouping("object-creator");
		
		//Configuration
		Config conf = new Config();
		//Set the Serializer/Deserializer for the User object
		conf.registerSerialization( User.class, UserSerializer.class);
